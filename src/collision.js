import { TRAIL_COLLISION_RADIUS, TRAIL_SAFE_FRAMES, TRAIL_WIDTH } from './constants.js';
...
export function checkTrailSegmentCollision(x, y, trail, radius, isOwnTrail, skipPoints) {
